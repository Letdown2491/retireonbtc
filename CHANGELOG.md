...
- Deterministic BTC needed/holdings now gross up retirement expenses by 1/(1−τ).
- Deducts post‑retirement spending grossed up for taxes in streaming and full‑path sims.
...
- entralized config: BITCOIN_PRICE_TTL, SIM_FAST, SIM_ACCURATE, FAST_MODE_SEED, SPENDING_STEP, INFLATION_STEP, INFLATION_MAX, HOLDINGS_STEP, INVESTMENT_STEP
